...
( function( $ ) {
	var style = $( '#esenia-color-scheme-css' );
	var	api = wp.customize;

	if ( ! style.length ) {
		style = $( 'head' ).append( '<style type="text/css" id="esenia-color-scheme-css" />' )
		                    .find( '#esenia-color-scheme-css' );
	}
	...
	function writeCSS(){
		...
		$('#esenia-preview-style-inline-css').text(cssOutput);
	}
