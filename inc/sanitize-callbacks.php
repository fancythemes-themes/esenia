 ...
 */
function esenia_sanitize_layout($value) {
 ...
 */
function esenia_sanitize_color_field($value) {
	return $value;
}
 ...
 * @return HTML string sanitized with wpkses.
 */
function esenia_sanitize_blog_list_view($value) {
 ...
 * @return HTML string sanitized with wpkses.
 */
function esenia_sanitize_footer_credit($value) {
	$allowed_tags = array(
						'a' => array(
							'href' => array(),
							'title' => array(),
 ...
 */
function esenia_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function esenia_sanitize_number_absint( $number, $setting ) {
 ...
 */
function esenia_sanitize_image( $image, $setting ) {
	/*
