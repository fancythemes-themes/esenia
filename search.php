	...
	<section id="primary" class="content-area <?php echo esc_attr($list_class); ?>">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title"><?php printf( esc_html__( 'Search Results for: %s', 'esenia' ), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
			</header><!-- .page-header -->
			...
			the_posts_pagination( array(
				'prev_text'          => esc_html__( 'Previous page', 'esenia' ),
				'next_text'          => esc_html__( 'Next page', 'esenia' ),
